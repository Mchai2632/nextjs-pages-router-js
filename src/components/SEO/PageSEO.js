...
export default function PageSEO({ title, description, image, type = "website" }) {
  ...
  return (
    <Head>
      ...
      {/* og */}
      <meta property="og:site_name" content="Michael Chai" key="MC BRANDD" />
      ...
      <meta name="twitter:description" content={description || defaultDescription} key="twitter_type" />
      <meta name="twitter:image" content={image || defaultImage} key="twitter_type" />
